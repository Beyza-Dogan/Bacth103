...
public class Ternary01 {
    ...
    public static void main(String[] args) {
        ...
        if(a>0){
            ...
            //Example 3: Verilen bir sayinin mulak degerini heseplayan bir kodu yaziniz
            ...
            //Example 4: Iki tane sayi ayni ise bu sayilari carpiniz, farkli isaretli ise "islem yapamam"mesaji veriniz
            int e = 12;
            int f = 10;

            //Ternary farklidata tiplerinde sonuc return ederse sonucun data tipini "Object"yaziniz
            Object islem = (e>0 && f>0) || (e<0 && f<0) ? e*f : "Islem yapamam";
            System.out.println(islem);

            //Note: Java'da her class'in en az bir tane "parent"class'i vardir.
            //      Sadece Öbject"class'in "parent"class'i yoktur.
