...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        //Examle 3: ilk isimve soy ismi iceren isimlerinden ilk ve soyisimlerin basharflerini ekrana yazdiriniz
        //            Ali Can ==> AC     TAhssin Yurdakul ==> TY
        System.out.println("Ilk soy isminizi giriniz");
